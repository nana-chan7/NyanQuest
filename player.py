...
class Player(pygame.sprite.Sprite, Character):
    def __init__(self,pos):
        ...
        # 仮 確認用
        self.all_image_list = (pygame.image.load("kariimage/migi1.png"),
                           pygame.image.load("kariimage/migi2.png"),
                           pygame.image.load("kariimage/hidari1.png"),
                           pygame.image.load("kariimage/hidari2.png"),
                           pygame.image.load("kariimage/jump1.png"),
                            pygame.image.load("kariimage/jump2.png"))
